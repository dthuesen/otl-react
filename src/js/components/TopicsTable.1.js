...
export default class TopicsTable extends React.Component {
  ...
  render() {
    ...
    const options = {
      ...
      clearSearch: true,
      sizePerPage: 90,
      // handleAddRow: this.refs.table.handleAddRowAtBegin(row),
    }
    
    //BACKUP
    //  <BootstrapTable data={this.state.topics} insertRow={ true } tableHeaderClass="td-header" tableBodyClass="td-body" cellEdit={cellEditProp} options={options} selectRow={selectRowProp} search={true} deleteRow={true} striped={true} pagination={true} ignoreSinglePage={true} >
    // BACKUP
    ...
    return ( 
      <div>
        ...
        <BootstrapTable data={dataTopics} insertRow={ true } deleteRow={true} >
